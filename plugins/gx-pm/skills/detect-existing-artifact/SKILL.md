...
요구사항정의서, 화면목록표 등 상위 산출물에 항목을 이어쓰기 한 경우,
하위 산출물도 갱신이 필요할 수 있으므로 안내한다:
...
새로 추가된 항목 {N}건에 대해 하위 산출물도 업데이트가 필요할 수 있습니다:
  ...
  1. /gx-화면목록표 — 새 요구사항에 대한 화면 추가
  2. /gx-프로그램정의서 — 새 화면에 대한 프로그램 추가
  3. /gx-단위테스트계획서 — 새 화면에 대한 테스트 추가
  4. /gx-추적매트릭스 — 추적 체인 갱신
