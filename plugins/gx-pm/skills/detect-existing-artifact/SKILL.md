...
파일을 읽어 항목 수와 마지막 수정일을 파악한 후, AskUserQuestion으로 선택을 요청한다:
...
| 화면목록표 | 마지막 화면ID의 SN | EHR_01_01_030 → 기존 ID 간격을 분석하여 다음 번호 부여 (예: +10 또는 +1) |
...
2. AskUserQuestion으로 수정할 내용을 요청:
